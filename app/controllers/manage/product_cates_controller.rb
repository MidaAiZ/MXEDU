class Manage::ProductCatesController < ManageController
  ...
  def destroy
    ...
    respond_to do |format|
      if @code
        format.html { redirect_to product_cates_path, notice: 'ProductCate was successfully destroyed.' }
        format.json { head :no_content }
      else
        format.html { redirect_to product_cates_path, notice: '删除失败,该分类已经绑定相关资料', status: 422 }
